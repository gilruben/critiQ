...
describe('user-api-test', () => {
  ...
  const users = [
    { username: 'shakespeare_papi', email: 'cmart@gmail.com', password: 'password', bio: 'I\'m LIT!!!', rating: 350, level: 'other', reviewerStatus: true },
    { username: 'edumacate', email: 'nhaque@gmail.com', password: 'password', bio: 'I have a phD in everythinG', rating: 2, level: 'post-grad', reviewerStatus: true },
    { username: 'j.pushw', email: 'jwu@gmail.com', password: 'password', bio: 'Graduated state Penn', rating: 9001, level: 'other', reviewerStatus: true },
  ];

  let newUser = { username: 'nate_dogg', email: 'ndogg@gmail.com', password: 'password', bio: 'I love scooby snacks', rating: 3522, level: 'professional', reviewerStatus: true };
  ...
  it('\'/api/users\' should respond with an error', (done) => {
    const newUser = { username: 'captain_crunch', email: 'captaincgmail.com', password: 'password', bio: 'Try my cereal, or else >:[', rating: -1, level: 'professional', reviewerStatus: true };
    supertest(server)
      .post('/api/users')
      .send(newUser)
      .end((err, res) => {
  ...
  it('\'/api/users\' should respond with an error', (done) => {
    const newUser = { username: 'edumacate', email: 'nhaque@gmail.com', password: 'password', bio: 'I have a phD in everythinG', rating: 2, level: 'post-grad', reviewerStatus: true };
